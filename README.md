...
- finishedConversation (Boolean): if the user has indicated they don't want help
...
# Job Objects
The job objects contain information to help the user decide if they want to learn more.  If so, they can link to the job on the company's career site (or ATS).  Each job object needs to include:
...
- cat1 - The categoryOne for the job (must equal a value for the company)
- cat2 - The categoryTwo for the job (must equal a value for the company)
